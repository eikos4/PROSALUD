...
def request_detail(request_id):
    ...
    messages = []  # Debes traer los mensajes de la BD si ya tienes el modelo
    form = MessageForm()

    # Aquí defines el otro usuario
    other_user = req.service.professional
    ...
    return render_template(
        ...
        messages=messages,
        form=form,
        other_user=other_user    # <- Esto es lo que faltaba
    )
