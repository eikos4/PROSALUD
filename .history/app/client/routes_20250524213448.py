...
# Supongamos en client/routes.py
@client.route('/my_requests/<int:request_id>')
@login_required
def request_detail(request_id):
    req = Request.query.get_or_404(request_id)
    messages = ... # tus mensajes asociados a la solicitud
    # FALTA: NO SE PASA EL 'form'
    return render_template('client/request_detail.html', req=req, messages=messages)
...
from app.forms import ResponseRequestForm  # el que tú uses

@client.route('/request/<int:request_id>')
@login_required
def request_detail(request_id):
    req = Request.query.get_or_404(request_id)
    return render_template('client/request_detail.html', req=req)
