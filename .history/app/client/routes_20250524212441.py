...
def my_requests():
    ...
    return render_template('client/my_requests.html', requests=solicitudes)
...
def request_detail(request_id):
    ...
    form = ResponseRequestForm()  # o el formulario correcto para la acción
    return render_template('client/request_detail.html', req=req, form=form)
