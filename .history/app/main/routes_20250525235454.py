...
@main.route('/')
def index():
    trending_services = ['Diseño Web', 'Abogados', 'Clases de Yoga', 'Contabilidad', 'Desarrollador App', 'Psicólogo', 'Análisis Comercial', 'Asesoría Laboral']
    return render_template('mainindex.html', trending_services=trending_services)
