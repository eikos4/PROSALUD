...
from app.forms import EditServiceForm  
...
def edit_service(service_id):
    ...
    if service.professional_id != current_user.id:
        abort(403)  # Seguridad: solo el dueño puede editar
...
from app.forms import EditServiceForm  # o el nombre de tu form

@professional.route('/edit_service/<int:service_id>', methods=['GET', 'POST'])
@login_required
def edit_service(service_id):
    service = Service.query.get_or_404(service_id)
