...
def profile():
    ...
    if form.validate_on_submit():
        ...
        # 📎 Guardar certificado (solo si se sube un nuevo archivo)
        ...
        # 📸 Guardar imagen de perfil (solo si se sube una nueva)
        image = form.profile_image.data
        if image and hasattr(image, 'filename') and image.filename:
            image_name = secure_filename(image.filename)
            img_dir = os.path.join(current_app.root_path, 'static/uploads/profile_images')
...
# ============================================================
# ARCHIVOS SUBIDOS (CERTIFICADOS / IMÁGENES)
# ============================================================
@professional.route('/uploads/<filename>')
def uploaded_file(filename):
    uploads_dir = os.path.join(current_app.root_path, 'static/uploads/certificates')
